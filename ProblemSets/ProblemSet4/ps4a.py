...
def updateHand(hand, word):
    ...
    # for letter in hand:
    #     freq = word_dict.get(letter, 0)
    #     if freq != 0:
    #         if hand[letter] - freq != 0:
    #             new_hand[letter] = hand[letter] - freq
    #     else:
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while hand_length > 0:
        ...
        displayHand(hand)
        # Ask user for input
        user_input = raw_input("Please enter a word or '.' to indicate you are finished:")
        ...
        # Otherwise (the input is not a single period):
            ...
            if not isValidWord(user_input, hand, wordList):
                ...
                print("Sorry that word is invalid!")
                print
            # Otherwise (the word is valid):
                ...
                score += word_score
                print "\""+user_input+"\""+" earned "+str(word_score)+" points. Your total score is now: "+str(score)
                print
                # Update the hand
                hand = updateHand(hand, user_input)
        hand_length = calculateHandlen(hand)
    # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    print "Game over! Your total score was: "+str(score)
